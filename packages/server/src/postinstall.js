...
const chatStorageWorkerPath = join(root, '.tmp/dist-chat-storage-worker/dist/chatStorageWorkerMain.js')
...
newContent = replaceWorkerUrl(newContent, 'chatStorageWorkerUrl', 'chat-storage-worker', 'chatStorageWorkerMain.js', chatStorageWorkerPath)
